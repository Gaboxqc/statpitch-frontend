      ...
      <div className={'flex items-center justify-between w-full m-2'}>
        ...
        <div className={'flex items-center '}>
          <div className={'justify-between gap-2 w-full px-4 hidden md:flex'}>
            <div
              className={
                'flex flex-col justify-center items-center h-14 w-14 border bg-primary/10 border-primary/50 rounded-lg text-xs'
              }
            >
              <p className={'text-secondary-foreground/60'}>1</p>
              <p className={'text-primary font-bold'}>{(home_win_prob * 100).toFixed(2)}%</p>
            </div>
            <div
              className={
            ...
            >
              ...
              <p className={'font-bold'}>{(away_win_prob * 100).toFixed(2)}</p>
            </div>
          </div>
